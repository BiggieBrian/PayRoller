...
import { Menu, X, Copy, Check, ChevronDown, Sparkles, Shield, RefreshCw } from 'lucide-react'
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white overflow-hidden relative font-sans selection:bg-emerald-500/30">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#09090b]/90 backdrop-blur-md border-b border-[#1f1f23]">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-xs font-mono tracking-wider uppercase">
            ...
            <a href="#demo" className="text-zinc-400 hover:text-white transition-colors duration-200">
              Sandbox Demo
            </a>
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link to="/login" className="text-xs font-mono tracking-wider uppercase text-zinc-400 hover:text-white transition-colors">
              Sign In
            </Link>
            <Link 
              to="/setup-restaurant" 
      ...
      <section className="relative pt-36 pb-20 px-6 border-b border-[#1f1f23] flex flex-col items-center justify-center">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl tracking-tight mb-8 font-serif leading-[1.15] font-light">
            Streamline your <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-400 font-normal">restaurant payroll</span> without the headache.
          </h1>
          ...
          <div className="bg-[#121214]/60 border border-[#1f1f23] rounded-xl p-6 md:p-8 backdrop-blur-md relative">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left">
              <div className="bg-[#09090b]/80 border border-[#1f1f23] p-5 rounded-lg">
                <div className="text-zinc-500 text-[10px] mb-2 font-mono tracking-widest uppercase">Active Staff</div>
                <div className="text-3xl font-light font-serif">14 <span className="text-xs text-zinc-500 font-mono">Members</span></div>
              </div>
              <div className="bg-[#09090b]/80 border border-[#1f1f23] p-5 rounded-lg">
                <div className="text-zinc-500 text-[10px] mb-2 font-mono tracking-widest uppercase">Net Liability</div>
                <div className="text-3xl font-light text-emerald-400 font-serif">Ksh 184,500</div>
              </div>
              <div className="bg-[#09090b]/80 border border-[#1f1f23] p-5 rounded-lg">
                <div className="text-zinc-500 text-[10px] mb-2 font-mono tracking-widest uppercase">Status Engine</div>
                <div className="text-base text-zinc-300 font-mono tracking-wide mt-1.5 flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-emerald-400"></span> All Accounts Synced
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="features" className="py-24 px-6 border-b border-[#1f1f23] relative">
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-px bg-[#1f1f23] border border-[#1f1f23] rounded-lg overflow-hidden">
            ...
            <div className="bg-[#09090b] p-8 hover:bg-[#121214]/50 transition-colors duration-300">
              ...
              <h3 className="text-lg font-mono tracking-tight uppercase mb-3">Flexible Setup</h3>
              <p className="text-zinc-400 text-sm leading-relaxed">
                Quickly onboard your restaurant and customize basic salaries, system deductions, and monthly schedules to fit your kitchen layout.
              </p>
            </div>
            ...
            <div className="bg-[#09090b] p-8 hover:bg-[#121214]/50 transition-colors duration-300">
              ...
              <h3 className="text-lg font-mono tracking-tight uppercase mb-3">Staff Credentials</h3>
              <p className="text-zinc-400 text-sm leading-relaxed">
                Generate secure portal logins automatically for all staff members so they can independently view pay slips, shifts, and schedules.
              </p>
            </div>
            ...
            <div className="bg-[#09090b] p-8 hover:bg-[#121214]/50 transition-colors duration-300">
              ...
              <h3 className="text-lg font-mono tracking-tight uppercase mb-3">Real-Time Adjustments</h3>
              <p className="text-zinc-400 text-sm leading-relaxed">
                Easily deduct for accidental breakages, track cash advances, and log till shortfalls dynamically as the busy month progresses.
              </p>
            </div>
      ...
      <section id="demo" className="py-24 px-6 border-b border-[#1f1f23] relative">
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <h2 className="text-3xl md:text-5xl tracking-tight mb-4 font-serif font-light">Onboarding Invitation Engine</h2>
          <p className="text-zinc-400 text-sm md:text-base mb-12 max-w-lg mx-auto leading-relaxed">
            Generate a localized onboarding token below. Send this secure invite link straight to your employee’s WhatsApp to let them securely fill out their credentials.
          </p>
          ...
          <div className="bg-[#121214] border border-[#1f1f23] rounded-xl p-8 space-y-6 text-left">
            <div className="grid sm:grid-cols-2 gap-6">
              {/* Role Dropdown */}
              <div>
                <label className="block text-xs font-mono tracking-wider uppercase mb-2 text-zinc-400">Designated Role</label>
            ...
            {generatedLink && (
              <div className="bg-[#09090b] border border-[#1f1f23] rounded p-5 space-y-4">
                <div className="text-[10px] font-mono tracking-widest text-zinc-500 uppercase">Generated WhatsApp Invite</div>
                <p className="text-xs text-zinc-300 font-mono break-all py-1 px-2 bg-[#121214] border border-[#1f1f23] rounded">{generatedLink}</p>
                <button
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-24 px-6 border-b border-[#1f1f23] relative">
        <div className="max-w-5xl mx-auto relative z-10">
          <div className="text-center max-w-xl mx-auto mb-16">
            ...
            <h2 className="text-3xl md:text-5xl tracking-tight mt-6 font-serif font-light">Simple, predictable structures</h2>
          </div>

          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* Free Tier */}
            <div className="bg-[#121214]/40 border border-[#1f1f23] rounded-xl p-8 flex flex-col justify-between">
              <div>
                <h3 className="text-lg font-mono tracking-wider uppercase mb-2">Basic Tier</h3>
                <div className="text-4xl font-serif font-light mb-6">Free</div>
                <div className="w-full h-px bg-[#1f1f23] mb-6"></div>
                <ul className="space-y-3.5 text-zinc-400 text-sm">
                  <li className="flex items-center gap-3">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                    Up to 10 active staff members
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                    Basic adjustment logs (advances & shorts)
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                    Manual payroll sheet export
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
              ...
              <Link 
                to="/setup-restaurant" 
                className="w-full mt-10 text-center border border-[#1f1f23] text-zinc-300 py-3 rounded-full text-xs font-mono tracking-wider uppercase font-bold hover:bg-zinc-800 transition-all duration-200"
              >
                Register Free Plan
              </Link>
            </div>
            ...
            {/* Pro Tier */}
            <div className="bg-[#121214] border border-emerald-500/30 rounded-xl p-8 relative overflow-hidden flex flex-col justify-between">
              <div className="absolute inset-0 bg-gradient-to-b from-emerald-500/[0.03] to-transparent pointer-events-none"></div>
              <div>
                <div className="flex justify-between items-start mb-2">
                  <h3 className="text-lg font-mono tracking-wider uppercase">Pro Tier</h3>
                  <span className="border border-emerald-500/30 px-2 py-0.5 rounded-full text-[9px] font-mono tracking-widest uppercase text-emerald-400 bg-emerald-950/20">
                    Coming Soon
                  </span>
                </div>
                <div className="text-4xl font-serif font-light mb-6">
                  Ksh 800 <span className="text-xs text-zinc-500 font-mono">/ month</span>
                </div>
                <div className="w-full h-px bg-[#1f1f23] mb-6"></div>
              ...
              <Link 
                to="/setup-restaurant" 
                className="w-full mt-10 text-center bg-white text-[#09090b] py-3 rounded-full text-xs font-mono tracking-wider uppercase font-bold hover:bg-emerald-400 transition-all duration-200"
              >
                Launch Pro Trial
              </Link>
            </div>
      ...
      {/* FAQ Section */}
      <section id="faq" className="py-24 px-6 border-b border-[#1f1f23] relative">
        <div className="max-w-3xl mx-auto relative z-10">
          <div className="text-center max-w-xl mx-auto mb-16">
            <span className="text-[10px] font-mono tracking-widest text-zinc-400 uppercase border border-[#1f1f23] px-3 py-1 rounded-full bg-[#121214]">
              FAQ
            </span>
            <h2 className="text-3xl md:text-5xl tracking-tight mt-6 font-serif font-light">Frequently Asked Questions</h2>
          </div>

          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              <div key={idx} className="border border-[#1f1f23] rounded-lg bg-[#121214]/20 overflow-hidden">
                <button
                  onClick={() => setExpandedFaq(expandedFaq === idx ? -1 : idx)}
                  className="w-full px-6 py-5 flex items-center justify-between hover:bg-[#121214]/60 transition-colors text-left"
                >
                  <span className="font-mono text-sm tracking-wide text-zinc-100">{faq.q}</span>
                  <ChevronDown
                    size={16}
      ...
      <footer className="py-16 px-6 bg-[#09090b] border-t border-[#1f1f23] relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-zinc-500 text-xs leading-relaxed max-w-xs">
                Keeping your kitchen operation and monthly ledger structured in harmony.
              </p>
            </div>

            {/* Links Columns */}
            <div>
              <h4 className="font-mono text-[10px] tracking-widest uppercase text-zinc-400 mb-4">Product</h4>
              <ul className="space-y-2 text-zinc-500 text-xs">
                ...
                <li><a href="#pricing" className="hover:text-white transition-colors">Subscriptions</a></li>
              </ul>
            </div>

            <div>
              <h4 className="font-mono text-[10px] tracking-widest uppercase text-zinc-400 mb-4">Company</h4>
              <ul className="space-y-2 text-zinc-500 text-xs">
                <li><Link to="/setup-restaurant" className="hover:text-white transition-colors">Register Admin</Link></li>
                <li><Link to="/login" className="hover:text-white transition-colors">Log In Portal</Link></li>
              </ul>
            </div>

            <div>
              <h4 className="font-mono text-[10px] tracking-widest uppercase text-zinc-400 mb-4">Support</h4>
              <ul className="space-y-2 text-zinc-500 text-xs">
                <li><a href="#faq" className="hover:text-white transition-colors">Common Inquiries</a></li>
                <li><span className="text-zinc-600">WhatsApp Hotlines</span></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-[#1f1f23] pt-8 flex flex-col sm:flex-row items-center justify-between text-zinc-600 text-[10px] font-mono tracking-wider">
            <p>© {new Date().getFullYear()} PayRoller. Beautifully keeping your kitchen and capital in sync.</p>
            <p className="mt-2 sm:mt-0 uppercase">Premium Restaurant Administration Platform</p>
          </div>
        </div>
      </footer>
